    ...
    <div className="p-5  relative">
      <div className="rounded-3xl shadow-[0_0_50px_-10px]">
        <Image
          ...
          width={1920}
          height={661}
          className="w-full h-auto rounded-3xl opacity-70"
        />
      </div>
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center w-[70%]">
        <h1 className="text-5xl font-bold pb-12 leading-snug">Discover New Home in Florida</h1>
        <input
          type="text"
          className="w-[600px] px-5 py-3 rounded-lg"
